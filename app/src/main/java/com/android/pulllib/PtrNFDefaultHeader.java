...
//    private PtrNFDefaultHeader.LastUpdateTimeUpdater mLastUpdateTimeUpdater = new PtrNFDefaultHeader.LastUpdateTimeUpdater();
    ...
    protected void initViews(AttributeSet attrs) {
        TypedArray arr = this.getContext().obtainStyledAttributes(attrs, in.srain.cube.views.ptr.R.styleable.PtrClassicHeader, 0, 0);
        if(arr != null) {
...
//        this.mLastUpdateTimeUpdater.start();
        ...
        if(frame.isPullToRefresh()) {
            mTitleTextView.setText(this.getResources().getString(in.srain.cube.views.ptr.R.string.cube_ptr_pull_down_to_refresh));
        } else {
            mTitleTextView.setText(this.getResources().getString(in.srain.cube.views.ptr.R.string.cube_ptr_pull_down_to_refresh));
        }
...
//        this.mTitleTextView.setTextColor(getResources().getColor(R.color.black));
        ...
        this.mTitleTextView.setVisibility(VISIBLE);
        this.mTitleTextView.setText(in.srain.cube.views.ptr.R.string.cube_ptr_refreshing);
        this.tryUpdateLastUpdateTime();
...
//        LogUtil.e("my", "lastUpdateTime:" + lastUpdateTime);
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if(!frame.isPullToRefresh()) {
            this.mTitleTextView.setVisibility(VISIBLE);
            this.mTitleTextView.setText(in.srain.cube.views.ptr.R.string.cube_ptr_release_to_refresh);
        }
    ...
    private void crossRotateLineFromBottomUnderTouch(PtrFrameLayout frame) {
        this.mTitleTextView.setVisibility(VISIBLE);
        if(frame.isPullToRefresh()) {
            this.mTitleTextView.setText(getResources().getString(in.srain.cube.views.ptr.R.string.cube_ptr_pull_down_to_refresh));
        } else {
            //不显示下拉刷新
            this.mTitleTextView.setText(this.getResources().getString(in.srain.cube.views.ptr.R.string.cube_ptr_pull_down_to_refresh));
        }
