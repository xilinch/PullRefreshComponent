...
/**
 * Created by xilinch on 18-7-22 下午8:06.
 * describe 该类主要完成以下功能
 * 1.显示评论列表
 */

public class RecycleViewAdapter extends PlusRecyclerAdapter {

    private List<Integer> list;

    private Context context;

    public RecycleViewAdapter(List<Integer> list,Context context){
        super(null);
