...
/**
 * Created by xilinch on 18-7-22 下午8:07.
 * describe 该类主要完成以下功能
 * 1.显示评论列表
 */

public class CustomHeaderAdapter extends PlusRecyclerAdapter {
    private List<Integer> list;

    private Context context;

    public CustomHeaderAdapter(List<Integer> list,Context context){
        super(null);
